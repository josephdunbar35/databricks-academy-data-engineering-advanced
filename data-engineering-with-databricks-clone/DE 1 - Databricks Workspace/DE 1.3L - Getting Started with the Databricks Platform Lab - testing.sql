...
-- MAGIC
-- MAGIC Run the following cell to verify that the **`example-setup`** notebook was executed by displaying the **`example_df`** DataFrame. This table consists of 15 rows of increasing values.
...
-- MAGIC * These are my bullet points
-- MAGIC * These are my bullet points
-- MAGIC * Links/Embedded HTML: <a href="https://www.biblegateway.com/passage/?search=2%20Timothy%202&version=NIV" target="_blank">2 Timothy 2</a>
...
-- MAGIC
-- MAGIC Run the following cell to query a Delta table using SQL. This executes a simple query against a table and is backed by a Databricks-provided example dataset included in all DBFS installations.
